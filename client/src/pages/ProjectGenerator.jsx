    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-indigo-50 via-purple-50 to-blue-50 pt-20 pb-8 px-4 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          >
            <span className="text-4xl">🎓</span> Project Idea Generator
            {isPremium && <span className="text-yellow-500 text-2xl ml-2">🌟</span>}
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          {/* {userName && (
            ...
            >
              <span className="text-sm font-medium text-gray-700 flex gap-1 items-center">
        ...
        {error && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="mb-6 p-4 bg-red-50 border-l-4 border-red-500 rounded-md text-red-700 flex justify-between items-center"
          >
            <span>{error}</span>
        ...
        {idea && (
          ...
          >
            <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
              <span className="text-2xl">💡</span> Your Project Idea
            </h2>
