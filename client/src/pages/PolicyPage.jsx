...
export const TermsAndConditions = () => (
    <PolicyPage title="Terms and Conditions">
        <p>
            Welcome to Toolpunk. By accessing or using our website and services,
            you agree to be bound by these Terms and Conditions. If you do not
            agree, please do not use our platform.
        </p>
        <ul>
            <li>
                All tools provided are for informational and project use only.
            </li>
            <li>
                You may not use Toolpunk for any unlawful or prohibited purpose.
            </li>
...
export const PrivacyPolicy = () => (
    <PolicyPage title="Privacy Policy">
        ...
        <ul>
            <li>
                We collect only necessary information such as your email and
                usage activity.
            </li>
...
export const RefundPolicy = () => (
    <PolicyPage title="Cancellations and Refunds">
        <p>
            Toolpunk offers digital services and tools. As such, purchases are
            non-refundable unless there was a technical issue or accidental
            duplicate charge.
        </p>
        <ul>
            <li>
                Refunds, if applicable, will be processed within 5-7 working
                days.
            </li>
            <li>
                To request a refund, please contact us at support@toolpunk.com.
            </li>
        </ul>
    </PolicyPage>
);
...
export const ShippingPolicy = () => (
    <PolicyPage title="Shipping Policy">
        <p>
            Toolpunk is a digital platform. No physical products are shipped.
            All services are delivered online instantly or via your account
            dashboard.
        </p>
    </PolicyPage>
);
