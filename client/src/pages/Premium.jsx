      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            {isPremium && <span className="text-yellow-500 text-3xl ml-2">🌟</span>}
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        {!isPremium && (
          ...
          >
            ...
            <p className="text-indigo-100 mb-6">
              Join thousands of students unlocking their potential for just ₹100/month.
            </p>
            {user ? (
              <motion.button
              ...
              >
                {loading || isProcessing ? (
                  ...
                  <>
                    ...
                    <span className="text-sm">(₹100/month)</span>
                  </>
                )}
              </motion.button>
            ) : (
