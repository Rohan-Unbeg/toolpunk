...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-indigo-50 via-purple-50 to-blue-50">
        ...
        {[...Array(6)].map((_, i) => (
          <div
            ...
            style={{
              ...
              background: `radial-gradient(circle, rgba(${Math.floor(Math.random() * 100 + 155)}, ${Math.floor(Math.random() * 50 + 90)}, ${Math.floor(Math.random() * 155 + 100)}, 0.15), transparent)`,
              borderRadius: "50%",
              filter: "blur(60px)",
